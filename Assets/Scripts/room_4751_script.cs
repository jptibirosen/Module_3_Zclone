...
public class room_4751_script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!level_cleared){
            Instantiate<GameObject>(enemy_archer_prefab, new Vector3(-1.79f, -0.81f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_archer_prefab, new Vector3(0.33f, -4.73f, 0f), Quaternion.Euler(0f, 0f, 0f));
