...
public class room_5156_script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!level_cleared){
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(2.85f, -3.25f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(-0.48f, 3f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_archer_prefab, new Vector3(4, 1.87f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_archer_prefab, new Vector3(4.04f, -0.87f, 0f), Quaternion.Euler(0f, 0f, 0f));
