...
public class room_5055_script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!level_cleared){
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(-6.37f, 0.38f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_archer_prefab, new Vector3(-6.38f, -1.59f, 0f), Quaternion.Euler(0f, 0f, 0f));
