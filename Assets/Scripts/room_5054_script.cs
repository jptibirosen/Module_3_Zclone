...
public class room_5054_script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!level_cleared){
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(-1.86f, 1.53f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_archer_prefab, new Vector3(6.23f, 0.67f, 0f), Quaternion.Euler(0f, 0f, 0f));
