...
public class room_5251_script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!level_cleared){
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(-1.68f, -6.2f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(7.1f, 1.5f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(9.3f, -1.5f, 0f), Quaternion.Euler(0f, 0f, 0f));
