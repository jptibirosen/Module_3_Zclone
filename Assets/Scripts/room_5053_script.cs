...
public class room_5053_script : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!level_cleared){
            Instantiate<GameObject>(enemy_swordsman_prefab, new Vector3(-2.15f, 3f, 0f), Quaternion.Euler(0f, 0f, 0f));
            Instantiate<GameObject>(enemy_archer_prefab, new Vector3(-6f, 0f, 0f), Quaternion.Euler(0f, 0f, 0f));
